...
<body>
   ...
   <div id="wrapper">
    ...
    <h2 style="text-align: center;">Terminarz</h2>  
    <form style="text-align: center;" action="terminarz.php" method="post">
        <select name="season">
    ...
    if(isset($_POST['season'])){
        if(!empty($_POST['season'])){
            ...
            FROM terminarz AS t1, skocznia as t2 where t1.id_skocznia=t2.id_skocznia and t1.season='$season' ORDER BY t1.date ASC";
           // $sql = "SELECT * from terminarz";
            if($result = @$polaczenie->query($sql)){
                $number_of_dates = $result->num_rows;
                if($number_of_dates>0){
                    echo "<h2 style='text-align: center;'>Sezon $season</h2>";
                    "<table id='terminarz'>";
                    //echo "<table border='0'>
